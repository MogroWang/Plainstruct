...
#[tauri::command]
pub fn list_custom_themes(state: State<'_, AppState>) -> Result<Vec<ThemeMeta>, String> {
...
#[tauri::command]
pub fn read_theme_files(state: State<'_, AppState>, theme_id: String) -> Result<HashMap<String, String>, String> {
    let root = state.site_root()?;
...
#[tauri::command]
pub fn delete_theme(state: State<'_, AppState>, theme_id: String) -> Result<(), String> {
    let root = state.site_root()?;
    let dir = theme_dir(&root, &theme_id)?;
    if dir.exists() {
...
#[tauri::command]
pub fn import_theme_zip(state: State<'_, AppState>, zip_path: String) -> Result<ThemeMeta, String> {
    let root = state.site_root()?;
    let themes = themes_root(&root);
    std::fs::create_dir_all(&themes).map_err(|e| e.to_string())?;
...
#[tauri::command]
pub fn export_theme_zip(files: HashMap<String, String>, dest_path: String) -> Result<(), String> {
