...
const paths: Record<string, string[]> = {
  ...
  settings: [
    "M12 2a2.5 2.5 0 0 1 2.5 2.5v.5l1.5.9.5-.3a2.5 2.5 0 0 1 3.4 1.1l1 1.7a2.5 2.5 0 0 1-.9 3.3l-.5.3.1 1.7v.6l.5.3a2.5 2.5 0 0 1 .9 3.3l-1 1.7a2.5 2.5 0 0 1-3.4 1.1l-.5-.3-1.5.9v.5a2.5 2.5 0 0 1-2.5 2.5h-2a2.5 2.5 0 0 1-2.5-2.5v-.5l-1.5-.9-.5.3a2.5 2.5 0 0 1-3.4-1.1l-1-1.7a2.5 2.5 0 0 1 .9-3.3l.5-.3-.1-1.7v-.6l-.5-.3a2.5 2.5 0 0 1-.9-3.3l1-1.7a2.5 2.5 0 0 1 3.4-1.1l.5.3 1.5-.9v-.5A2.5 2.5 0 0 1 10 2z",
